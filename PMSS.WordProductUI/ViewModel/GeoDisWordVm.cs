...
{
    public class GeoDisWordVm : INotifyPropertyChanged
    {
        public Window wd;
        ...
        private readonly string templateFileName = "地灾模板.doc";
        ...
        public GeoDisWordVm()
        {
            ...
            this.Section = new ProductVolumeConfig().productVolume.GeoDisVolume.ToString();
        }
        ...
        public void WordMake()
        {
            ...
            try
            {
                ...
                con.productVolume.GeoDisVolume = volume;
            ...
            string outFileName = this.outPath + "/hv" + outFileYear + outFileMonth + outFileDay + outFileHour;
            ...
            TextBoxOnPic fromToText = new TextBoxOnPic
            {
                ...
                FontName = "宋体",
                Size = 7,
                Text = outFileMonth + "月" + outFileDay + "日" + outFileHour + "时～" + tomorrow.Month.ToString("00") + "月"
                + tomorrow.Day.ToString("00") + "日" + outFileHour + "时"
            };
            pbm.ListTextBox.Add(fromToText);

            TextBoxOnPic wh = new TextBoxOnPic
            {
                Left = 240,
                Top = 400,
                Width = 150,
            ...
            TextBoxOnPic pubText = new TextBoxOnPic
            {
                ...
                FontName = "宋体",
                Size = 7,
                Text = DateTime.Now.Month + "月" + DateTime.Now.Day + "日" + DateTime.Now.Hour + "时发布"
            };
