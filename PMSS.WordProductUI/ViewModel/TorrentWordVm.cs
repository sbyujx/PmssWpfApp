...
{
    public class TorrentWordVm : INotifyPropertyChanged
    {
        public Window wd;
        ...
        private readonly string templateFileName = "山洪模板.docx";
        private readonly string dir = "WordTemplate";


        public TorrentWordVm()
        {
            ...
            this.Section = new ProductVolumeConfig().productVolume.TorrentVolume.ToString();
        }
        ...
        public void WordMake()
        {
            ...
            try
            {
                ...
                con.productVolume.TorrentVolume = volume;
            ...
            string outFileName = this.outPath + "/sh" + outFileYear + outFileMonth + outFileDay + outFileHour;
            ...
            TextBoxOnPic pubText = new TextBoxOnPic
            {
                ...
                FontName = "宋体",
                Size = 7,
                Text = "水利部 中国气象局\n" + DateTime.Now.Month + "月" + DateTime.Now.Day + "日" + DateTime.Now.Hour + "时联合发布"
            };
